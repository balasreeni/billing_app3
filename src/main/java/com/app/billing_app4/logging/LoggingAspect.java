package com.app.billing_app4.logging;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.app.billing_app4.controller.*.*(..)) || execution(* com.app.billing_app4.services.*.*(..)) || execution(* com.app.billing_app4.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.app.billing_app4.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.app.billing_app4.controller.*.*(..))")
